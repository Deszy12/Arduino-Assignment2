...
A 7 segment display counts down from 0 to 9. On each step , a passive buzzer plays a short beep. When the countdown reaches 0 , the buzzer plays a longer tone to signal completion
## Hardware used
- Arduino Uno-
...
- Breadboard and jumper wires
  ...
  - Passive vs active buzzers- 7-segment display wiring (common cathode)-   -  2D arrays for digit patterns (lookup table)-
